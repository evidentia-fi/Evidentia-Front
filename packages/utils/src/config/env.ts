...
export const env = {
  ...
  TRON_ADDRESS: process.env.NEXT_PUBLIC_TRON_ADDRESS ?? 'TK69h36Z5gjvLbkyfUW9aNjSPRL17jXy2W',
  BASE_ADDRESS: (process.env.NEXT_PUBLIC_BASE_ADDRESS ?? '0xcb352448236F4A9E2bC56fa8f59851c6a5a34256') as Address,
